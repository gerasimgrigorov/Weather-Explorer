...
export async function loader() {
  ...
  if (isCacheValid(cachedData)) {
    ...
    try {
      ...
      console.error("Failed to fetch the weather data for the UK.", e);
      throw new Error("Failed to fetch the weather data for the UK.");
    }
  }
}
    ...
    <div className="uk-page">
      ...
      {loading ? (
        ...
        <>
          ...
          <MapContainer center={[53.483959, -2.244644]} zoom={5} style={{ height: "500px", marginTop: "2em" }}>
            <TileLayer
